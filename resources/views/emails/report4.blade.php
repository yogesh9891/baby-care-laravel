...
<div style="padding-top: 45px;padding-bottom: 100px;justify-content: center">
...
<p style="color: red;">Red Flags for Gross Motor Development (Age 4 - 5 Years):</p>
...
<ul>
    ...
    <li>Child cannot catch a ball with both hands & arms extended </li>
    <li>Child cannot pump a swing </li>
    <li>Child cannot kick a ball with a good backward & forward Leg Swing (by Flexing Knee) and follow through </li>
</ul>
...
<ul>
<li>Pencil skills (colouring, drawing, writing) </li>
<li>Scissors skills (cutting)</li>
</ul>
<p>Play</p>
<ul> 
<li>Construction skills using lego, duplo, puzzles, train tracks </li>
...
<li> Dressing – doling up sandals, zips, buttons, belts, dressing & undressing</li>
<li> Eating – using cutlery, opening lunch boxes & food bags, unwrapping biscuits & chocolate wrapper</li>
<li> Hygiene – brushing teeth, brushing hair, toileting</li>
...
<p style="color:red;">
Red Flags for Fine Motor Development (Age 4 - 5 Years):
</p>
<p>
...
<ul>
<li>Child cannot write alphabets and numbers with a pencil</li>
<li>Child cannot draw shapes and designs with a pencil</li>
<li>Child cannot cut shapes on a paper</li>
<li>Child cannot fold and crease a paper</li>
<li>Child cannot string fine beads</li>
</ul>
...
Common problems when this skill is weak: Difficulty in following and remembering simple one step directions, forgetting what was just said in a conversation.
</p>
<p>
Logic & Reasoning<br>
What it does: Enables you to reason, form ideas and solve problems.<br>
Common problems when this skill is weak: Frequently asking, “What do I do next?” or saying, “I don’t get this,” and difficulty in understanding rules of any game.

</p>
<p>
Auditory Processing<br>
What it does: Enables you to analyze, blend and segment sounds.<br>
Common problems when this skill is weak: Struggling with learning to read, reading fluency, or reading comprehension and difficulty in understanding the meaning of what is said & asked by another person, difficulty in understanding stories
.
</p>
<p>
Visual Processing<br>
What it does: Enables you to think in visual images.<br>
Common problems when this skill is weak: Difficulties understanding what you’ve just read, remembering what you’ve read, difficulty in identifying alphabets, numbers, shapes and difficulty in solving zig saw puzzles.
</p>
<p>
Processing Speed<br>
...
Red Flags for Cognitive Development (Age 4 - 5 Years):
</p>
<p>
...
<li>Child cannot describe a picture in detail </li>
<li>Child does not follow three steps instructions </li>
<li>Child cannot count minimum 10 objects </li>
<li>Child cannot recall events properly</li>
...
=======
That means, {{ucfirst($name)}}’s Developmental Age in Cognitive Motor domain is likely to be {{intVal($dage/12)}} years {{($dage%12)}} {{($dage%12) > 1?'Months':'Month'}} . So, we need to buckle up.</p>
>>>>>>> new_deployment
...
@endforeach
  ...
  <div style="text-align:center;">
<<<<<<< HEAD
        <img src="{{asset('images/compass.png')}}" width="200">
    </div>
    <p>
...
<p>
CompassTot singularly focuses on Taking the Guesswork Out in Raising a Toddler, by being your Personalized Neuroscientific Compass, to Assist You Skillfully Navigate & Make the Best Possible Use of the Golden Window of Core Skills Development, so {{ucfirst($name)}}  can Discover his Maximum Potential when he steps out in the real world.
</p>
<p>
