...
<p>That means, {{ucfirst($name)}}’s Overall Developmental Age is likely to be {{intVal($dage/12)}} years {{($dage%12)}} {{($dage%12) > 1?'Months':'Month'}} Yippee…!!! 
...
<p><b>But isn’t IQ Fixed at Birth…?</b></p>
...
<br>
<p ><b>Which Core Domains of Development does CompassTot Focus on…?</b></p>
...
<li>3.  Cognitive and Intellectual Skills, such as counting or identifying shapes</li>
    ...
    <p>So our priority, specifically for this domain of development, should be to make sure that {{$gender1}} continues to remain ahead of the normal developmental curve going forward too and does not lose {{$gender2}} lead because of missing out on doing right things, at the right time & in the right way. And while we are at it, let us also try to improve the extent and quality of {{$gender2}} lead, without putting any undue pressure on {{$gender2}}.</p>
...
<p style="color: red;font-weight: bold;">Red Flags for Gross Motor Development (Age 3 - 4 Years):</p>
...
<li>Child cannot catch a medium sized playground ball </li>
<li>Child cannot peddle a tricycle </li>
<li>Child cannot use a slide independently </li>
<li>Child cannot hop on one foot</li>
...
<li>Pencil skills (scribbling, colouring, drawing, writing)</li>
<li> Scissors skills (cutting)</li>

</ul>
<p>Play skills</p>
<ul> 
<li>Building a tower using blocks </li>
<li>Construction skills using blocks of medium size </li>
<li> Fixing  jigsaw puzzles</li>
</ul>
<p >Self-help skills including</p>

<ul style="padding-bottom: 50px">
<li>Dressing – buttoning & unbuttoning large buttons, buckling & unbuckling shoes & belt, wearing socks </li>
<li>Eating – using cutlery, opening lunch boxes & food bags </li>
<li>Hygiene – washing hands with soap, washing & drying face</li>
</ul>
<p >
...
Red Flags for Fine Motor Development (Age 3 - 4 Years):
</p>
<p>
...
<ul>
<li> Child cannot hold a crayon with a precision like a proper pencil grip </li>
<li> Child cannot cut a piece of paper on a line </li>
<li> Child cannot copy a vertical, horizontal line and circle using a crayon </li>
<li> Child cannot fold a paper</li>
<li> Child cannot colour within lines</li>
...
Common problems when this skill is weak: Forgetting names of objects, colours etc., forgetting things that were known earlier.<br>
Memory - Working (Or Short-Term)<br>
</p>
<p style="padding-top: 45px" >
What it does: Enables you to hang on to information while in the process of using it.<br><br>
...
Common problems when this skill is weak: Frequently asking, “What do I do next?” or saying, “I don’t get this,” and difficulty in understanding rules of any game.<br>
</p>
<p >
Auditory Processing<br>

What it does: Enables you to analyze, blend and segment sounds.<br>
Common problems when this skill is weak: Difficulty in understanding the meaning of what is said and asked by another person, difficulty in understanding stories.  <br>
</p>
<p>
Visual Processing<br>
What it does: Enables you to think in visual images.
Common problems when this skill is weak: Difficulty in identifying alphabets, numbers, & shapes, difficulty in solving zig saw puzzles.
</p>
<p>
Processing Speed<br>
What it does: Enables you to perform tasks quickly and accurately.
Common problems when this skill is weak: Most tasks are more difficult. Taking a long time to complete tasks for preschool, frequently being the last one in a group to finish something.


</p>

<b style="color:red;font-weight: bold;">
Red Flags for Cognitive Development (Age 3 - 4 Years):
</b>
<p>
...
<li>Child cannot identify alphabets & numbers </li>
...
<li> Child cannot solve 4 to 8 pieces puzzle</li>
<li>Child does not follow two steps instructions </li>
<li>Child does not take an interest in listening to stories</li>
...
<p>
Dear {{ucfirst($name)}}’s Parents, <br><br>
CompassTot sincerely thanks you for taking time out and reading through the report…! We hope that this was helpful for you and it will give you a good understanding of different domains of development & how is {{ucfirst($name)}}  faring in each of those, which will assist you in deciding the direction that will maximize developmental progression of {{ucfirst($name)}} . <br>
<br>As you know, developmental progression is not only about the speed of achieving milestones/skills, but also about the quality of those milestones/skills – as both play an important role in determining whether the resulting neural connection that form as strong or weak.
</p>
<p>
...
(Please note, if you did not register for your Free Trial immediately after requesting for your report, you may need to give this test again, for us to be able to curate activities for {{ucfirst($name)}}  according to{{$gender2}} current developmental stage.)<br><br>
