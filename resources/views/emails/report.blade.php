...
<div style="text-align: center;">
    <img src="{{asset('images/boy.png')}}" ><br>
=======
...
<p style="color: red;">Red Flags for Gross Motor Development (Age 2 - 3 Years):</p>
...
<ul>
    ...
    <li>Child cannot run well (falls often) </li>
    <li>Child cannot balance on one leg and kick a ball by flexing another leg </li>
    <li>Child cannot throw a ball with both hands from an overhead position </li>
</ul>
...
Pre-academics skills including</p>
<ul>
<li> Holding a crayon or chalk and scribbling </li>
<li>  Holding scissors and snipping a paper</li>
</ul>
<p>Play skills</p>
<ul> 
<li>Building a tower using blocks </li>
<li> Putting wooden pegs in their slots in a pegboard </li>
<li> Fixing a simple 2-piece jigsaw puzzle</li>
</ul>
<p>Self-help skills including</p>

<ul style="padding-bottom: 50px">
<li>Eating and drinking – opening jars, eating with spoon, holding a small cup in one hand & drinking </li>
<li>Dressing – putting on half pants, unbuttoning large buttons </li>
<li> Hygiene – wiping nose, drying wet hands</li>
</ul>
<p>
...
Red Flags for Fine Motor Development (Age 2 - 3 Years):
</p>
<p>
...
<ul>
<li>Child is not able to hold a crayon & scribble</li>
<li>Child is not able to build a tower using blocks</li>
<li>Child is not able to hold scissors in one hand and open & close scissors</li>
<li>Child is not able to string large beads</li>
</ul>
...
Common problems when this skill is weak: Difficulty in understanding how to play with toys.<br>
</p>
<p>
Auditory Processing<br>
What it does: Enables you to analyze, blend and segment sounds.<br>
Common problems when this skill is weak: Difficulty in understanding the meaning of what is said and asked by another person.<br>
</p>
<p>
Visual Processing<br>
What it does: Enables you to think in visual images.<br>
Common problems when this skill is weak: Difficulty in sorting, identifying & matching shapes, colours, objects etc.<br>
</p>
<p>
Processing Speed<br>
What it does: Enables you to perform tasks quickly and accurately.<br>
Common problems when this skill is weak: Difficulty in doing any activity according to the instruction given by another person.<br>

</p>

<p style="color:red;">
Red Flags for Cognitive Development (Age 2 - 3 Years):
</p>
<p>
...
<li>Child is not able to sort objects by their characteristics (e.g., colour, size, shape etc.)</li>
<li>Child is not able to complete a 2-to-4-piece puzzle</li>
<li>Child does not show any interest in listening to stories</li>
</ul>
</p>
